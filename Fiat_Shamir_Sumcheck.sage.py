...
# This file was *autogenerated* from the file Fiat_Shamir_Sumcheck.sage
from sage.all_cmdline import *   # import sage library

_sage_const_101 = Integer(101); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1)
import hashlib
from itertools import product

# Field and ring
F = GF(_sage_const_101 )
R = PolynomialRing(F, names=('x1', 'x2',)); (x1, x2,) = R._first_ngens(2)
...
class FSProver:
    ...
    def send_univariate(self, i, prefix_vals):
        ...
        s0 = hypercube_sum(self.f.subs(defaults).subs({Xi: F(_sage_const_0 )}), suffix_vars)
        s1 = hypercube_sum(self.f.subs(defaults).subs({Xi: F(_sage_const_1 )}), suffix_vars)
        return s0 + (s1 - s0) * Xi
